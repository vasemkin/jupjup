...
export type SwapModeParameterParameter = typeof SwapModeParameterParameter[keyof typeof SwapModeParameterParameter];
 ...
 */
export type AmountParameterParameter = number;
...
export const postSwapInstructions = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `/swap-instructions`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: swapRequest
    },
      options);
...
export const getIndexedRouteMap = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `/indexed-route-map`, method: 'GET',
        params
    },
      options);
    }
...
export type PostSwapInstructionsResult = NonNullable<Awaited<ReturnType<typeof postSwapInstructions>>>
